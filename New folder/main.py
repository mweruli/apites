...
async def upload_xml(file: bytes = File(...)):
    ...
    for invoice in data ['BatchResult']['Invoice']:
        ...
        # await cursor.execute(sql, (invoice_number, cu_serial_number,cu_invoice_number,value_after_cu_invoice_number, date_time))
        # await connection.commit()
        # print("Invoice Number:", invoice_number)
        # print("CU Serial Number:", cu_serial_number)
        # print("CU Invoice Number:", cu_invoice_number)
        # print("Datetime:", date_time)
        # print("amount:", value_after_cu_invoice_number)
